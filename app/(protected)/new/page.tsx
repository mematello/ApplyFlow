  ...
  return (
    <div className="max-w-4xl mx-auto p-8 text-gray-900">
      ...
      <div className="mb-10 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <textarea
          className="w-full h-40 p-3 rounded-md bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400"
      ...
      <form onSubmit={handleSave} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <h2 className="text-xl font-semibold mb-6 border-b border-gray-200 pb-4 text-gray-900">Application Details</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input required type="text" name="company_name" value={formData.company_name} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>
            
            <div>
              <label className="block text-sm text-gray-600 mb-1">Role</label>
              <input required type="text" name="role" value={formData.role} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Salary Range</label>
              <input type="text" name="salary_range" value={formData.salary_range} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Location</label>
              <input type="text" name="location" value={formData.location} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Source (e.g. LinkedIn)</label>
              <input type="text" name="source" value={formData.source} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="date" name="date_applied" value={formData.date_applied} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Recruiter Name</label>
              <input type="text" name="recruiter_name" value={formData.recruiter_name} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Contact Info</label>
              <input type="text" name="contact_info" value={formData.contact_info} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Resume Version</label>
              <input type="text" name="resume_version" value={formData.resume_version} onChange={handleInputChange} className="w-full p-2 rounded-md bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" />
            </div>
          </div>
        </div>
            ...
            <div className="p-2 min-h-[42px] rounded-md bg-white border border-gray-300 flex flex-wrap gap-2 items-center focus-within:ring-2 focus-within:ring-blue-500">
              {formData.tech_stack.map((tech, idx) => (
                <span key={idx} className="bg-gray-100 text-gray-800 border border-gray-200 text-sm px-2 py-1 rounded flex items-center gap-1">
                  {tech}
                  <button type="button" onClick={() => removeTech(tech)} className="text-gray-400 hover:text-gray-900">&times;</button>
                </span>
              ))}
              <input
                type="text"
                ...
                className="bg-transparent border-none outline-none flex-1 text-sm min-w-[150px] text-gray-900 placeholder:text-gray-400"
              />
            </div>
          </div>
